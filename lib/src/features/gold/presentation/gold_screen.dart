            ...
            children: [
              ...
              StreamBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  return Text(NumberFormat.simpleCurrency(locale: 'de_DE').format(snapshot.data),style: Theme.of(context).textTheme.headlineLarge!.copyWith(color: Theme.of(context).colorScheme.primary),);
           


                  } else {
                    return const Text("Keine Daten Verfugbar");
                  }
